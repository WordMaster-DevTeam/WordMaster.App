...
namespace WordMaster.Gameplay
{
	...
	public class Switch : Trigger
	{
		...
		internal Switch( SquareStructure holder, string name, string description, bool onlyOnceActivated, bool proximityActivated, bool hidden, SquareStructure square)
		...
		/// <summary>
		/// Activate this instance of <see cref="Switch"/> class for a <see cref="CharacterBreed"/>.
		/// </summary>
