...
namespace WordMaster.Gameplay
{
	...
	{	
		...
		internal Trap( SquareStructure holder, string name, string description, bool onlyOnceActivated, bool proximityActivated, bool hidden, bool ignoreArmor, int intensity )
		...
		/// <summary>
		/// Gets if this <see cref="Trap"/> ignore <see cref="CharacterBreed"/>'s armor.
		/// </summary>
		...
		/// <summary>
		/// Activate this instance of <see cref="Trap"/> class for a <see cref="CharacterBreed"/>.
		/// </summary>
