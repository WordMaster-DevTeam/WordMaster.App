...
namespace WordMaster.Gameplay
{
	...
	{
		/// <summary>
		/// Gets (read only) all the instances of <see cref="CharacterBreed"/> class initialized in this instance of <see cref="GlobalContext"/> class.
		/// </summary>
		public IEnumerable<CharacterBreed> Characters
		{
			get { return _characters; }
		}

		/// <summary>
		/// Gets the number of instance of <see cref="CharacterBreed"/> class initialized in this instance of <see cref="GlobalContext"/> class.
		/// </summary>
		...
		/// <summary>
		/// Adds an instance of <see cref="CharacterBreed"/> class in this instance of <see cref="GlobalContext"/> class.
		...
		internal CharacterBreed AddDefaultCharacter( string name )
		{
			CharacterBreed character = new CharacterBreed( this, name, "A standard guy without particuliar ambition. Height 1,79 meter with helmet and weight 91 kilograms with armor.", 100, 0, 1, 10 );
		...
		public CharacterBreed AddCharacter( string name, string description, int hp, int xp, int level, int armor )
		{
			...
			CharacterBreed character = new CharacterBreed( this, name, description, hp, xp, level, armor );
			_characters.Add( character );
			return character;
		}
		...
		public bool TryAddCharacter( string name, string description, int hp, int xp, int level, int armor, out CharacterBreed character )
		{
			try
			{
		...
		/// <param name="description">Character's description.</param>
		/// <returns>New Character's reference.</returns>
		public CharacterBreed AddCharacter( string name, string description )
		{
		...
		/// <param name="character">Character's reference to recover.</param>
		/// <returns>If the Character have been created and added.</returns>
		public bool TryAddCharacter( string name, string description, out CharacterBreed character )
		{
			try
			{
		...
		/// <summary>
		/// Removes an instance of <see cref="CharacterBreed"/> class from this instance of <see cref="GlobalContext"/>.
		...
		public bool TryRemoveCharacter( CharacterBreed character )
		{
		...
		/// </summary>
		/// <param name="character">Character's reference.</param>
		public void ForceRemoveCharacter( CharacterBreed character )
		{
		...
		/// <summary>
		/// Sets the name of this instance of <see cref="CharacterBreed"/> int his instance of <see cref="GlobalContext"/>.
		...
		public void RenameCharacter( CharacterBreed character, string newName )
		{
		...
		public bool TryRenaneCharacter( CharacterBreed character, string newName )
		{
			try
			{
		...
		/// <summary>
		/// Gets the reference of the instance of <see cref="CharacterBreed"/> class in the current instance of <see cref="GlobalContext"/> class.
		/// </summary>
		/// <param name="name">Character's name.</param>
		/// <returns>Character's reference, if found.</returns>
		public CharacterBreed GetCharacter( string name )
		{
		...
		public bool TryGetCharacter( string name, out CharacterBreed character )
		{
		...
		/// <summary>
		/// Checks if an instance of <see cref="CharacterBreed"/> class with the specified name exists in the current instance of <see cref="GlobalContext"/> class.
		/// </summary>
		/// <param name="name">Character's name.</param>
		/// <returns>If the Character have been found.</returns>
