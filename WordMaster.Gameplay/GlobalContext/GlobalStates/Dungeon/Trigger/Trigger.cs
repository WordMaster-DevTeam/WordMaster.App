...
namespace WordMaster.Gameplay
{
	...
	public abstract class Trigger
	{
		...
		internal Trigger( SquareStructure holder, string name, string description, bool onlyOnceActivated, bool proximityActivated, bool hidden )
		{
			_holder = holder;
			_name = name;
		...
		/// <summary>
		/// Gets the instance of <see cref="SquareStructure"/> class that holds this instance of <see cref="Trigger"/> class.
		/// </summary>
		...
		/// <summary>
		/// Activate this instance of <see cref="Trigger"/> class for a <see cref="CharacterBreed"/>.
		/// </summary>
		/// <param name="user">Character's reference, the user of this <see cref="Trigger"/>.</param>
		internal virtual void Activate( CharacterBreed user )
		{
			Hidden = false;
			_count++;
		}
