...
namespace WordMaster.Gameplay
{
    ...
    public class DungeonStructure
    {
		...
		readonly Dictionary<string, FloorStructure> _floors;
		...
		/// <summary>
		/// Gets the name of this instance of <see cref="DungeonStructure"/> class.
		/// </summary>
		public string Name
		{
			get { return _name; }
		...
		/// </summary>
		public IEnumerable<FloorStructure> Floors
		{
		...
		/// <summary>
		/// Checks if this instance of <see cref="DungeonStructure"/> class have any instance of <see cref="CharacterBreed"/> class using it.
		/// </summary>
		public bool Editable
		{
			get
			{
				foreach( CharacterBreed character in _globalContext.Characters ) // Any Character in it ?
		...
		public bool Finishable
		{
			get
			{
				if( Entrance == null && Exit == null) // Entrance & Exit set ?
					...
					foreach( FloorStructure floor in Floors ) // All Squares set ?
		...
		public FloorStructure AddFloor( int level, string name, string description, int numberOfLines, int numberOfColumns )
		{
			...
			foreach( FloorStructure aFloor in Floors )
		...
		{
			foreach( FloorStructure floor in Floors )
