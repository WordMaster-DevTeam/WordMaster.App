...
namespace WordMaster.Gameplay
{
    ...
    public class CharacterBreed
    {
		...
		/// </summary>
		internal CharacterBreed( GlobalContext globalContext, string name, string description, int health, int experience, int level, int armor)
		{
		...
		/// <summary>
		/// Gets or sets (this DLL only) the <see cref="CharacterBreed"/>'s name.
		/// </summary>
        public string Name
        {
            get { return _name; }
		...
		/// <summary>
		/// Gets or sets the <see cref="CharacterBreed"/>'s description.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets (this DLL only) the <see cref="CharacterBreed"/>'s maximum health points.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets (this DLL only) the <see cref="CharacterBreed"/>'s health points.
		/// </summary>
        public int Health
        {
            get { return _health; }
		...
		/// <summary>
		/// Gets or sets the <see cref="CharacterBreed"/>'s experience points.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="CharacterBreed"/>'s level.
		/// </summary>
        public int Level
        {
            get { return _level; }
		...
		/// <summary>
		/// Gets or sets the <see cref="CharacterBreed"/>'s armor.
		/// </summary>
        public int Armor
        {
            get { return _armor; }
		...
		/// <summary>
		/// Gets the list (read-write) of <see cref="ItemType"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets if this <see cref="CharacterBreed"/> is alive.
		/// </summary>
		public bool Alive
		{
		...
		/// <summary>
		/// Get if this <see cref="CharacterBreed"/> is dead.
		/// </summary>
		public bool Dead
		{
			get { return _health <= 0; }
		...
		/// <summary>
		/// Set this <see cref="CharacterBreed"/> class by giving him his maximum of health
		/// </summary>
		...
		{
			if( gameContext.Dungeon.Entrance == null ) throw new ArgumentException( "No entrance.", "dungeon" );
			if( gameContext.Dungeon.Exit == null ) throw new ArgumentException( "No exit.", "dungeon" );

			_historics.Add( gameContext.Historic );
			_dungeon = gameContext.Dungeon;
			_floor = gameContext.Dungeon.Entrance.Floor;
			_square = gameContext.Dungeon.Entrance;
		...
		/// <summary>
		/// Moves an instance of <see cref="CharacterBreed"/> class to a different Square.
		...
		public bool TryMoveTo( SquareStructure target )
		{
        ...
        {
			SquareStructure square = _floor[line, column];
