...
namespace WordMaster.Gameplay
{
	...
	public class FloorStructure
	{
		...
		/// <summary>
		/// Gets the reference of the instance <see cref="Dungeon"/> class where this instance of <see cref="FloorStructure"/> class is.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the level of this instance of <see cref="FloorStructure"/> class in the instance of <see cref="Dungeon"/> which contains it.
		/// </summary>
		public int Level
		{
			get { return _level; }
		...
		/// <summary>
		/// Gets the description of this instance of <see cref="FloorStructure"/> class.
		/// </summary>
		...
		/// <summary>
		/// Getst the number of <see cref="SquareStructure"/>s in this instance of <see cref="FloorStructure"/> class.
		/// </summary>
